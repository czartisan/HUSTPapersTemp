\documentclass[supercite,macfont,fandolfont]{HustGraduPaper}

\title{庆余年超级大结局篇}
\author{五竹叔} %作者姓名
\date{\today} %日期，默认当日
\school{监察院} %院系名称
\classnum{金融工程1601班} %专业班级
\stunum {U888888888} %学号
\instructor{大宗师} %指导教师姓名
...
\titleformat{\section}{\raggedright \songti \bfseries \zihao{4}}{\chinese{section}、}{0em}{}
\titleformat{\subsection}{\raggedright \songti \bfseries \zihao{-4}}{（\chinese{subsection}）}{0em}{}
\titleformat{\subsubsection}{\raggedright \songti \bfseries \zihao{-4}}{\arabic{subsubsection}、}{0em}{}
...
\statement 	
	...
	%正文内容从这里开始
	\section{第一节}
	这是小四号的正文字体，段间距1.5倍一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是
	
	通过空一行实现段落换行，仅仅是回车并不会产生新的段落
	\par 也可以通过\verb|\par|命令来新起一段一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字
	\subsection{第一小节}
	一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一
	\subsubsection{第一小小节}
这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大
	\subsubsection{第二小小节}

这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是
	...
	\subsection{第三小节}
	这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一大段文字这是一
	\section{新的大节}
	新的大节会自动出现在新的一页上
